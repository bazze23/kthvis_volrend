 ...
 **/
#ifndef SINGLE_PASS_VOLUME_RENDERING_RAY_CASTING_ESS_H
#define SINGLE_PASS_VOLUME_RENDERING_RAY_CASTING_ESS_H
...
class RayCasting1PassEmptySpaceSkipping : public BaseVolumeRenderer {
  public:
	RayCasting1PassEmptySpaceSkipping();
	virtual ~RayCasting1PassEmptySpaceSkipping();

	//////////////////////////////////////////
	// Virtual base functions
	virtual const char* GetName() { return "1-Pass - Ray Casting with Empty Space Skipping"; }
	virtual const char* GetAbbreviationName() { return "s_1rcess"; }
